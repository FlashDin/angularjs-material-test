...
var mod = angular.module('home.controller', [
    'home.service'
]);

mod.controller('HomeCtrl', homeCtrl);

function homeCtrl($scope, HomeService, $timeout, $mdSidenav, $mdUtil, $log) {
    ...
    this.colorTiles = (function () {
        var tiles = [];
        var now = new Date();
        var titles = ["Dashboard Chart", "Tanggal", "", ""];
        var icons = ["fa-pie-chart", "", "", ""];
        var subtitles = ["Chart", now.getDay() + "/" + now.getMonth() + "/" + now.getFullYear(), "", ""];
        var urils = ["/#/app/dashboard2", "/#/app/dashboard", "/#/app/dashboard", "/#/app/dashboard"];
...
homeCtrl.$inject = ['$scope', 'HomeService', '$timeout', '$mdSidenav', '$mdUtil', '$log'];

mod.controller('LeftCtrl', function ($scope, $timeout, $mdSidenav, $log) {
...
mod.controller('RightCtrl', function ($scope, $timeout, $mdSidenav, $log) {
    $scope.close = function () {
